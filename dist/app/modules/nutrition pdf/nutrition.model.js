...
const petNutritionSchema = new mongoose_1.Schema({
...
const PetNutritionModel = mongoose_1.default.model("PetNutrition", petNutritionSchema);
exports.default = PetNutritionModel;
